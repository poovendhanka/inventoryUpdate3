...
public interface RawMaterialRepository extends JpaRepository<RawMaterial, Long> {
    ...
    Page<RawMaterial> findTopByOrderByLorryInTimeDesc(Pageable pageable);
    List<RawMaterial> findByLorryInTimeBetweenOrderByLorryInTimeDesc(LocalDateTime start, LocalDateTime end);
